...
#include <wallet/scriptpubkeymanxxx.h>
#include<pubkey.h>
#include<rpc/rawTransactionAF.h>

// /home/ideofuzion/Bitcoin/bitcoin/src/pubkey.h
                               ...
                               CCoinsViewCache& view, bool fJustCheck)
{
    ...
    std::cout<<"CONNECT BLOCK CALLED NOW --->>>>"<<std::endl;
    ...
    for (unsigned int i = 0; i < block.vtx.size(); i++)
    {
        ...
        //     std::cout<<"{ "<<std::endl;
        //     std::cout<<"value : ";
        //     std::cout<<tx.vout[i].nValue<<std::endl;
        //     std::cout<<"hash : "<<std::endl;
        //     // std::cout<<tx.vout[i].Serialize<<std::endl;
        //     std::cout<<"Script : ";
        //     const CTxOut& output = tx.vout[i];
        //     const CScript& script = output.scriptPubKey;
        //     // std::cout<<script.data()<<std::endl;

        //     std::cout<<HexStr(script).substr(0, 30)<<std::endl;


        //     //Extracting public key of sender from ScriptPubKey 
...
void Chainstate::UpdateTip(const CBlockIndex* pindexNew)
{
    ...
    std::cout<<"Logging UpdateTip Now ---->>>"<<std::endl;
    AssertLockHeld(::cs_main);
...
bool Chainstate::ConnectTip(BlockValidationState& state, CBlockIndex* pindexNew, const std::shared_ptr<const CBlock>& pblock, ConnectTrace& connectTrace, DisconnectedBlockTransactions& disconnectpool)
{
    ...
    std::cout<<"Calling ConnectTip Noww --->>>> "<<std::endl;
    AssertLockHeld(cs_main);
    if (m_mempool) AssertLockHeld(m_mempool->cs);
